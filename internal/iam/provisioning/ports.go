...
type Commands interface {
	...
	Update(ctx context.Context, p Principal, userID identity.UserID, input Update) (User, error)
	Authenticate(ctx context.Context, raw string) (Principal, error)
}
type Queries interface {
	Find(ctx context.Context, p Principal, userID identity.UserID) (User, error)
...
type ControlCommands interface {
	...
	Revoke(ctx context.Context, m Mutation, credentialID identity.CredentialID) error
...
type ControlRepository interface {
	...
	RevokeCredential(ctx context.Context, m Mutation, credentialID identity.CredentialID) error
	Link(ctx context.Context, m Mutation, input Link) error
	Credentials(ctx context.Context, environment identity.EnvironmentID) ([]CredentialView, error)
}
